...
const AssetRegisterPage = () => {
  ...
  return (
    <div>
      ...
      */}
     {nextButton ? (useCardQuery.data && useCardQuery.data.card_list ? <CardRegister cardList={useCardQuery.data.card_list} /> : null) : (useAccountQuery.data && useAccountQuery.data.account_list ? <AccountRegister accountList={useAccountQuery.data.account_list} /> : null)}
      {nextButton ? null : (
