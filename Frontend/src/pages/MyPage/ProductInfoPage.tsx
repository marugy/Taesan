...
const ProductInfoPage = () => {
  ...
  return (
    <div className='h-screen flex flex-col font-main'>
      ...
      <div className="flex items-center font-main text-end text-xs dt:text-base text-gray-600">2023.10.05 준법감시인-2023-9 심의필 <br></br>(유효기간 2025.10.23)
</div>
</div>
...
<div className="border border-gray-300 rounded-xl p-2 text-center w-full dt:w-4/5">
      ...
      <div className="font-light dt:text-lg text-gray-600">적용세율은 2023.10.05. 현재의 세율이며, 관계법령의 개정에 따라 변경될 수 있음</div>
      ...
      <div className="font-semibold text-sm dt:text-lg text-gray-600">이 설명서는 금융소비자의 권익 보호 및 예금상품에 대한 이해 증진을 위하여 '금융소비자 보호에 관한 법률' 및 관련 규정에 의거,
태산의 내부 통제절차를 거쳐 예금상품의 주요 내용을 쉽게 이해할 수 있도록 작성한 자료입니다.

설명내용을 제대로 이해하지 못하였음에도 불구하고 설명을 이해했다는 서명을 하거나 녹취기록을 남기시는 경우, 추후 해당 내용과 관련한 권리구제가 어려울 수 있습니다.</div>
