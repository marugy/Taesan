...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                ...
                .antMatchers("/api/auth-management/**", "/api/member-management/members/join", "/api/member-management/members/login", "/v3/api-docs/**", "/swagger-ui/**", "/swagger-ui.html").permitAll()
