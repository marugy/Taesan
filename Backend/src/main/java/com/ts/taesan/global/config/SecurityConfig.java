...
//                .antMatchers("/api/auth-management/**", "/api/member-management/members/join", "/api/member-management/members/login", "/api/member-management/members/simple-login", "/v3/api-docs/**", "/swagger-ui/**", "/swagger-ui.html", "/**").permitAll()
                .antMatchers("/api/auth-management/**", "/api/member-management/members/join", "/api/member-management/members/check", "/api/member-management/members/login", "/api/member-management/members/simple-login", "/v2/api-docs/**", "/swagger-ui/**", "/swagger-ui.html", "/swagger-resources/**").permitAll()
